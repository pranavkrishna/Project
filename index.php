	...
	<body style="min-width: 980px;">
		<div class="homepageheader" style="position: relative;">
			...
			<div style="float: left; margin: 5px 0px 0px 23px;">
				<a href="index.php">
					<img style=" height: 75px; width: 130px;" src="image/giftverselogo.png">
				</a>
			</div>
			<div class="">
				<div id="srcheader">
					<form id="newsearch" method="get" action="search.php">
					        <input type="text" class="srctextinput" name="keywords" size="21" maxlength="<120></120>"  placeholder="Search Here..."><input type="submit" value="search" class="srcbutton" >
					</form>
		...
		<div class="home-welcome">
			<div class="home-welcome-text" style="background-image: url(image/homebackgrndimg001.png); height: 380px; ">
				<h1 style="margin: 0px;">Welcome To Giftverse</h1>
				<h2>India's Largest Online Handmade Gift Shop</h2>
			</div>
		</div>
		<div class="home-prodlist">
			<div>
				<h3 style="text-align: center;">Gifts Category</h3>
			</div>
